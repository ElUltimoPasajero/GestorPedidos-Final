...
public class MainScreenController implements Initializable {
    ...
    /**
     * Método para manejar el evento de salida.
     *
     ...
     *
     * @param url            La ubicación relativa al código de la raíz del objeto o null si no se conoce la ubicación.
     * @param resourceBundle Los recursos locales para esta vista.
     */
    @Override
